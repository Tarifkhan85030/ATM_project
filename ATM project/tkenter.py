...
class ATM:
    def __init__(self, root):
        ...
        try:
            self.pin_image = ImageTk.PhotoImage(Image.open("img/key.png").resize((50, 50)))
            self.change_pin_image = ImageTk.PhotoImage(Image.open("img/key.png").resize((50, 50)))
            self.balance_image = ImageTk.PhotoImage(Image.open("img/money.png").resize((50, 50)))
            self.withdraw_image = ImageTk.PhotoImage(Image.open("img/withdrow.png").resize((50, 50)))
            self.exit_image = ImageTk.PhotoImage(Image.open("img/exit.png").resize((50, 50)))
